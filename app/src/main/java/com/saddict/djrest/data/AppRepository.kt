...
import com.saddict.djrest.data.DataMapper.Companion.mapToEntity
...
class AppRepository(
    ...
    private val appApi: ApiRepository = AppApi().productsRepository,
...
//    val token = CryptoManager().decrypt(
