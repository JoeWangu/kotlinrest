                ...
                onClick = {
                    coroutineScope.launch {
                        ...
                        viewModel.uiState.collect { state ->
                            when (state) {
                                com.saddict.djrest.products.data.manager.AppUiState.Error -> ctx.toastUtil(
                                    "Unable to register " +
                                            "please try again later"
                                )

                                com.saddict.djrest.products.data.manager.AppUiState.Loading -> ctx.toastUtil(
                                    "Waiting for response"
                                )

                                is com.saddict.djrest.products.data.manager.AppUiState.Success -> {
