...
//                }
//            },
//            saveToFavourites = { saveToFavourites(it.id) },
            onProductClick = { navigateToItemDetails(it.id) },
...
//    saveToFavourites: (ProductsResult) -> Unit,
    modifier: Modifier = Modifier
) {
        ...
        items(products.itemCount, key = products.itemKey { it.id }) { index ->
            ...
            product.let {
                if (it != null) {
                    ProductCard(
                        product = it,
//                        saveToFavourites = { saveToFavourites(product!!) },
                        modifier = Modifier
                            .padding()
