package com.saddict.djrest.products.ui.screens.home
...
import com.saddict.djrest.products.data.manager.usecases.InsertFavouriteUseCase
...
import com.saddict.djrest.utils.DataMapper.Companion.mapToFavourites
...
//    private val repository: ApiRepository,
    ...
    private val useCase: InsertFavouriteUseCase,
...
//        private set
    ...
    fun addFavourite(favourites: ProductsResult) {
        viewModelScope.launch {
            withContext(Dispatchers.IO) {
                useCase.insertFavourite(favourites.mapToFavourites())
            }
        }
    }
